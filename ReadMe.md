MAAWG 2014-2 Bro Training Syllabus:
===============
...
3. A Tour of the Bro logs
  ...
  2. Run Bro against a PCAP: ```bro -r /opt/TrafficSamples/faf-exercise.pcap```
  3. Look at the logs generated: ```ls *.log```
  4. Go through some of the logs (e.g. cat files.log | colorize); intro to log guides
  5. Let's enable some additional scripts: ```bro -r /opt/TrafficSamples/faf-exercise.pcap local```
...
5. Sumstats Introduction
  ...
  2. Review [FTP Bruteforcing](https://github.com/LiamRandall/BroTraining-MAAWG-2014-2/blob/master/brute-force.md) or check it locally: ```less -S /opt/bro/share/bro/policy/protocols/ftp/detect-bruteforcing.bro```
  ...
  5. Review [HTTP Basic Auth Brute Forcer Solution](https://github.com/LiamRandall/BroTraining-MAAWG-2014-2/blob/master/detect-http-basic-auth-bruteforcer.bro)
  6. Review [HTTP Basic Auth Server Brute Forced Solution](https://github.com/LiamRandall/BroTraining-MAAWG-2014-2/blob/master/detect-http-basic-auth-server-bruteforced.bro)
